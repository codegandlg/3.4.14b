...
MibChangeFuncItem_t mibReinitFuncSet[] =
{
	...
	{"reinit_func_lan_app_samba",REINIT_LAN_APP_SAMBA_FUNC_ID,reinit_func_lan_app_samba,REINIT_FUNC_PRIORITY_LAN_APP_SAMBA},
#endif

#ifdef CONFIG_APP_MINIDLNA
	{"reinit_func_lan_app_minidlna",REINIT_LAN_APP_MINIDLNA_FUNC_ID,reinit_func_lan_app_minidlna,REINIT_FUNC_PRIORITY_LAN_APP_MINIDLNA},
#endif
