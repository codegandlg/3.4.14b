...
#define MIB_CUSTOMER_HW_SET_FLG CUSTOMER_HW_MIB_BaseId+2
...
/* ====== USER MIB BEGIN ====== */
#define MIB_FIRST_LOGIN					16000
#define MIB_DEV_VERSION					16001
#define MIB_DEV_RESTART_ENABLE			16002
#define MIB_DEV_RESTART_TIME			16003
#define MIB_GUEST_NEWORK_VALID_TIME		16004
#define MIB_AUTO_WLAN_ENABLED		    16005
/* parent conctrl mib begin */
#define PARENT_CONCTRL_GROUPS_NUMBER				6	

#define MIB_PARENT_CONCTRL_GROUP0_ENABLE		16006
#define MIB_PARENT_CONCTRL_GROUP1_ENABLE		(MIB_PARENT_CONCTRL_GROUP0_ENABLE+1)
#define MIB_PARENT_CONCTRL_GROUP2_ENABLE		(MIB_PARENT_CONCTRL_GROUP0_ENABLE+2)
#define MIB_PARENT_CONCTRL_GROUP3_ENABLE		(MIB_PARENT_CONCTRL_GROUP0_ENABLE+3)
#define MIB_PARENT_CONCTRL_GROUP4_ENABLE		(MIB_PARENT_CONCTRL_GROUP0_ENABLE+4)
#define MIB_PARENT_CONCTRL_GROUP5_ENABLE		(MIB_PARENT_CONCTRL_GROUP0_ENABLE+5)
#define MIB_PARENT_CONCTRL_GROUP0_NAME		    (MIB_PARENT_CONCTRL_GROUP0_ENABLE+6)
#define MIB_PARENT_CONCTRL_GROUP1_NAME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+7)
#define MIB_PARENT_CONCTRL_GROUP2_NAME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+8)
#define MIB_PARENT_CONCTRL_GROUP3_NAME	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+9)
#define MIB_PARENT_CONCTRL_GROUP4_NAME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+10)
#define MIB_PARENT_CONCTRL_GROUP5_NAME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+11)
#define MIB_PARENT_CONCTRL_GROUP0_TIME	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+12)
#define MIB_PARENT_CONCTRL_GROUP1_TIME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+13)
#define MIB_PARENT_CONCTRL_GROUP2_TIME	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+14)
#define MIB_PARENT_CONCTRL_GROUP3_TIME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+15)
#define MIB_PARENT_CONCTRL_GROUP4_TIME	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+16)
#define MIB_PARENT_CONCTRL_GROUP5_TIME			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+17)
#define MIB_PARENT_CONCTRL_GROUP0_LIST	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+18)
#define MIB_PARENT_CONCTRL_GROUP1_LIST			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+19)
#define MIB_PARENT_CONCTRL_GROUP2_LIST		    (MIB_PARENT_CONCTRL_GROUP0_ENABLE+20)
#define MIB_PARENT_CONCTRL_GROUP3_LIST			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+21)
#define MIB_PARENT_CONCTRL_GROUP4_LIST	        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+22)
#define MIB_PARENT_CONCTRL_GROUP5_LIST			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+23)
#define MIB_PARENT_CONCTRL_GROUP0_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+24)
#define MIB_PARENT_CONCTRL_GROUP1_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+25)
#define MIB_PARENT_CONCTRL_GROUP2_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+26)
#define MIB_PARENT_CONCTRL_GROUP3_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+27)
#define MIB_PARENT_CONCTRL_GROUP4_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+28)
#define MIB_PARENT_CONCTRL_GROUP5_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+29)

#define MIB_PARENT_CONCTRL_VALID_NUM			(MIB_PARENT_CONCTRL_GROUP0_ENABLE+30)
#define MIB_GUEST_NEWORK_SET_FLG		        (MIB_PARENT_CONCTRL_GROUP0_ENABLE+31)
/* parent conctrl mib end ==> MIB_PATENT_CONTRL_GROUP6_NUM 16029 */
#define MIB_LED_ENABLE		 			16038
#define MIB_LED_CONTROL_DISABLE		 	16039


/*parent control for device*/
#define MIB_PARENT_CONTRL_TBL_NUM		16050
#define MIB_PARENT_CONTRL_TBL			((MIB_PARENT_CONTRL_TBL_NUM+1)|MIB_TABLE_LIST)
#define MIB_PARENT_CONTRL_ADD			((MIB_PARENT_CONTRL_TBL_NUM+2)|MIB_ADD_TBL_ENTRY)
#define MIB_PARENT_CONTRL_DEL			((MIB_PARENT_CONTRL_TBL_NUM+3)|MIB_DEL_TBL_ENTRY)
#define MIB_PARENT_CONTRL_DELALL		((MIB_PARENT_CONTRL_TBL_NUM+4)|MIB_DELALL_TBL_ENTRY)

#define MIB_PARENT_CONTRL_WEEK_MON           (MIB_PARENT_CONTRL_TBL_NUM+10)
#define MIB_PARENT_CONTRL_WEEK_TUES          (MIB_PARENT_CONTRL_TBL_NUM+11)
#define MIB_PARENT_CONTRL_WEEK_WED           (MIB_PARENT_CONTRL_TBL_NUM+12)
#define MIB_PARENT_CONTRL_WEEK_THUR          (MIB_PARENT_CONTRL_TBL_NUM+13)
#define MIB_PARENT_CONTRL_WEEK_FRI           (MIB_PARENT_CONTRL_TBL_NUM+14)
#define MIB_PARENT_CONTRL_WEEK_SAT           (MIB_PARENT_CONTRL_TBL_NUM+15)
#define MIB_PARENT_CONTRL_WEEK_SUN           (MIB_PARENT_CONTRL_TBL_NUM+16)
#define MIB_PARENT_CONTRL_START_TIME         (MIB_PARENT_CONTRL_TBL_NUM+17)
#define MIB_PARENT_CONTRL_END_TIME           (MIB_PARENT_CONTRL_TBL_NUM+18)
#define MIB_PARENT_CONTRL_TERMINAL           (MIB_PARENT_CONTRL_TBL_NUM+19)
#define MIB_PARENT_CONTRL_ENABLED            (MIB_PARENT_CONTRL_TBL_NUM+20)

#define MAX_PARENT_CONTRL_TIME_NUM_LIST		 8
#define TERMINAL_NAME_LEN                    3200

/*klink data*/
/*version information for upgrade firmware*/
#define MIB_KLINK_LOCAL_SOFT_VERSION		16075
#define MIB_KLINK_SLAVE1_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+1)   //formate macaddr;fwVersion: 11:22:33:44:55:66;WM V1.0.5.6
#define MIB_KLINK_SLAVE2_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+2)
#define MIB_KLINK_SLAVE3_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+3)
#define MIB_KLINK_SLAVE4_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+4)
#define MIB_KLINK_SLAVE5_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+5)
#define MIB_KLINK_SLAVE6_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+6)
#define MIB_KLINK_SLAVE7_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+7)
#define MIB_KLINK_SLAVE8_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+8)
#define MIB_KLINK_SLAVE9_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+9)
#define MIB_KLINK_SLAVE10_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+10)
#define MIB_KLINK_SLAVE11_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+11)
#define MIB_KLINK_SLAVE12_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+12)
#define MIB_KLINK_SLAVE13_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+13)
#define MIB_KLINK_SLAVE14_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+14)
#define MIB_KLINK_SLAVE15_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+15)
#define MIB_KLINK_SLAVE16_SOFT_VERSION		(MIB_KLINK_LOCAL_SOFT_VERSION+16)

#define MIB_KLINK_LOCAL_MESH_NAME			(MIB_KLINK_LOCAL_SOFT_VERSION+17)
#define MIB_KLINK_SLAVE1_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+1)
#define MIB_KLINK_SLAVE2_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+2)
#define MIB_KLINK_SLAVE3_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+3)
#define MIB_KLINK_SLAVE4_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+4)
#define MIB_KLINK_SLAVE5_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+5)
#define MIB_KLINK_SLAVE6_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+6)
#define MIB_KLINK_SLAVE7_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+7)
#define MIB_KLINK_SLAVE8_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+8) //100
#define MIB_KLINK_SLAVE9_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+9)
#define MIB_KLINK_SLAVE10_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+10)
#define MIB_KLINK_SLAVE11_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+11)
#define MIB_KLINK_SLAVE12_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+12)
#define MIB_KLINK_SLAVE13_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+13)
#define MIB_KLINK_SLAVE14_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+14)
#define MIB_KLINK_SLAVE15_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+15)
#define MIB_KLINK_SLAVE16_MESH_NAME			(MIB_KLINK_LOCAL_MESH_NAME+16)

#define MIB_KLINK_LOCAL_SN					(MIB_KLINK_LOCAL_MESH_NAME+17) 		//16109
#define MIB_KLINK_SLAVE1_SN					(MIB_KLINK_LOCAL_SN+1)
#define MIB_KLINK_SLAVE2_SN					(MIB_KLINK_LOCAL_SN+2)
#define MIB_KLINK_SLAVE3_SN					(MIB_KLINK_LOCAL_SN+3)
#define MIB_KLINK_SLAVE4_SN					(MIB_KLINK_LOCAL_SN+4)
#define MIB_KLINK_SLAVE5_SN					(MIB_KLINK_LOCAL_SN+5)
#define MIB_KLINK_SLAVE6_SN					(MIB_KLINK_LOCAL_SN+6)
#define MIB_KLINK_SLAVE7_SN					(MIB_KLINK_LOCAL_SN+7)
#define MIB_KLINK_SLAVE8_SN					(MIB_KLINK_LOCAL_SN+8)
#define MIB_KLINK_SLAVE9_SN					(MIB_KLINK_LOCAL_SN+9)
#define MIB_KLINK_SLAVE10_SN				(MIB_KLINK_LOCAL_SN+10)
#define MIB_KLINK_SLAVE11_SN				(MIB_KLINK_LOCAL_SN+11)
#define MIB_KLINK_SLAVE12_SN				(MIB_KLINK_LOCAL_SN+12)
#define MIB_KLINK_SLAVE13_SN				(MIB_KLINK_LOCAL_SN+13)
#define MIB_KLINK_SLAVE14_SN				(MIB_KLINK_LOCAL_SN+14)
#define MIB_KLINK_SLAVE15_SN				(MIB_KLINK_LOCAL_SN+15)
#define MIB_KLINK_SLAVE16_SN				(MIB_KLINK_LOCAL_SN+16)
...
typedef struct parent_contrl_entry {
#define MIBDEF(_ctype,	_cname, _crepeat, _mib_name, _mib_type, _mib_parents_ctype, _default_value, _next_tbl, decision_id, reinit_id ) \
	_ctype _cname _crepeat;
...
#undef MIBDEF
}__PACK__ PARENT_CONTRL_T, *PARENT_CONTRL_Tp;
