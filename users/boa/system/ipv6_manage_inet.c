        ...
        if (lanOrigin==0){ // lan auto mode
            if(dhcpPdEnable){
				...
				if(dhcp6_pd.flag){
					...
					htons(raPrefix->prefix.s6_addr16[4]),htons(raPrefix->prefix.s6_addr16[5]),
					htons(raPrefix->prefix.s6_addr16[6]),htons(raPrefix->prefix.s6_addr16[7])+16);
					sprintf(dhcp6sCfgParam.addr6PoolE,"%04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x",
					htons(raPrefix->prefix.s6_addr16[0]),htons(raPrefix->prefix.s6_addr16[1]),
					htons(raPrefix->prefix.s6_addr16[2]),htons(raPrefix->prefix.s6_addr16[3]),
					htons(raPrefix->prefix.s6_addr16[4]),htons(raPrefix->prefix.s6_addr16[5]),
					htons(raPrefix->prefix.s6_addr16[6]),htons(raPrefix->prefix.s6_addr16[7])+254);
					...
					sprintf(tmpStr,"/bin/ifconfig br0 %04x:%04x:%04x:%04x:%04x:%04x:%04x:%04x/128",
					htons(raPrefix->prefix.s6_addr16[0]),htons(raPrefix->prefix.s6_addr16[1]),
					htons(raPrefix->prefix.s6_addr16[2]),htons(raPrefix->prefix.s6_addr16[3]),
					htons(raPrefix->prefix.s6_addr16[4]),htons(raPrefix->prefix.s6_addr16[5]),
					htons(raPrefix->prefix.s6_addr16[6]),htons(raPrefix->prefix.s6_addr16[7])+1);
					system(tmpStr);
