    ...
    a.widget("bootstrap.bwizard", {
        ...
        _createButtons: function() {
            ...
            if (!this.buttons) {
                ...
                if (g != "") {
                	var ww_value=document.getElementById("password1").value;
        ...
        show: function(f) {
            ...
            e.nextIndex = f;
            var ww_value=document.getElementById("password1").value;
            var ww_value2=document.getElementById("password2").value;
        	if(!ww_value){
        		if(i18nLanguage=='en'){
        		...
        		return false;
        	}else if(ww_value.length<6){
        		if(i18nLanguage=='en'){
        			alert("The password is less than 6 bits!");       			
        		}else{
        			alert("密码小于6位!");
        		}       		
        		return false;
        	}else if(ww_value!=ww_value2){
        		if(i18nLanguage=='en'){
        			alert("The two passwords differ!");       			
        		}else{
        			alert("两次输入的密码不一致!");
        		}       		
        		return false;
        ...
        next: function() {
            ...
            if(d.activeIndex==0&&!ww_value){
            	...
            	if(i18nLanguage=='en'){
            		alert("Setting Password is different from a confirmation password");
            	}else{
            		alert("设置密码与确认密码不同");
            	}
