...
//#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_G6    //wps default GPIO
#define BSP_WPS_BTN_PIN		        BSP_GPIO_PIN_E2   //kingsignal:wps gpio
...
/*status led*/
#define BSP_STA_R_LED_PIN       BSP_GPIO_PIN_E4    //red status led
#define BSP_STA_G_LED_PIN       BSP_GPIO_PIN_H1    //green status led
#define BSP_STA_B_LED_PIN       BSP_GPIO_PIN_E3    //blue status led
...
static struct rtl819x_gpio_platdata rtl_pdata_led3 = {
	.flags		= 0,
	.name		= "sta_r led",
};

static struct platform_device rtl_led_dev3 = {
	.name		= "rtl819x_led",
	.id			= 2,
	.dev		= {
		.platform_data = &rtl_pdata_led3
	},
};

static struct rtl819x_gpio_platdata rtl_pdata_led4 = {
	.flags		= 0,
	.name		= "sta_g led",
};

static struct platform_device rtl_led_dev4 = {
	.name		= "rtl819x_led",
	.id			= 3,
	.dev		= {
		.platform_data = &rtl_pdata_led4
	},
};

static struct rtl819x_gpio_platdata rtl_pdata_led5 = {
	.flags		= 0,
	.name		= "sta_b led",
};

static struct platform_device rtl_led_dev5 = {
	.name		= "rtl819x_led",
	.id			= 4,
	.dev		= {
		.platform_data = &rtl_pdata_led5
	},
};
...
#endif
    rtl_pdata_led3.gpio = BSP_STA_R_LED_PIN;
    rtl_pdata_led4.gpio = BSP_STA_G_LED_PIN;
    rtl_pdata_led5.gpio = BSP_STA_B_LED_PIN;
