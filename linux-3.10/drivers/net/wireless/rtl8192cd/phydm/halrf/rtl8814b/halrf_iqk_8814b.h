...
#ifndef __HALRF_IQK_8814B_H__
#define __HALRF_IQK_8814B_H__

#if (RTL8814B_SUPPORT == 1)
/*@--------------------------Define Parameters-------------------------------*/
#define MAC_NUM_8814B 1
#define BB_NUM_8814B 31
#define RF_NUM_8814B 1

#define IQK_DELAY_8814B 2
#define IQK_STEP_8814B 12
#define RXK_STEP_8814B 2
#define IQK_CMD_8814B 0x8
#define DIQC 0x40000000
...
#define phy_iq_calibrate_8814b(_pdm_void, clear, segment_iqk)

#endif /* RTL8814B_SUPPORT */

#endif /*__HALRF_IQK_8814B_H__*/
