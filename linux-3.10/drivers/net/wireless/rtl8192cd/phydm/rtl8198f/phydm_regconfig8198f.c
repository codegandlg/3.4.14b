	...
	u32 data)
{
	...
	odm_config_rf_reg_8198f(dm, addr, data, RF_PATH_A, addr | maskfor_phy_set);
	...
	u32 data)
{
	...
	odm_config_rf_reg_8198f(dm, addr, data, RF_PATH_B, addr | maskfor_phy_set);
	...
	u32 data)
{
	...
	odm_config_rf_reg_8198f(dm, addr, data, RF_PATH_C, addr | maskfor_phy_set);
	...
	u32 data)
{
	...
	odm_config_rf_reg_8198f(dm, addr, data, RF_PATH_D, addr | maskfor_phy_set);
...
void odm_config_bb_agc_8198f(
	...
	u32 data)
{
	/*odm_update_agc_big_jump_lmt_8198f(dm, addr, data);*/
