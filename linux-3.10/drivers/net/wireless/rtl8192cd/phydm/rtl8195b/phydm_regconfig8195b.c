...
void odm_config_rf_radio_a_8195b(struct dm_struct *dm, u32 addr, u32 data)
{
	...
	odm_config_rf_reg_8195b(dm, addr, data, RF_PATH_A, addr | maskfor_phy_set);
...
void odm_update_agc_big_jump_lmt_8195b(struct dm_struct *dm, u32 addr, u32 data)
{
...
void odm_config_bb_agc_8195b(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
	odm_update_agc_big_jump_lmt_8195b(dm, addr, data);
...
#elif (DM_ODM_SUPPORT_TYPE & (ODM_WIN | ODM_IOT))
