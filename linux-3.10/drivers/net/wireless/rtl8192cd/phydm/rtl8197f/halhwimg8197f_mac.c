...
const u32 array_mp_8197f_mac_reg[] = {
		0x020, 0x000000BD,
		0x021, 0x0000001D,
		0x004, 0x00000012,
		0x007, 0x00000014,
...
odm_read_and_config_mp_8197f_mac_reg(struct dm_struct *dm)
{
	...
	u32	array_len =
			sizeof(array_mp_8197f_mac_reg) / sizeof(u32);
	u32	*array = (u32 *)array_mp_8197f_mac_reg;
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_mac_8197f(dm, v1, (u8)v2);
		}
		i = i + 2;
	}
}
...
u32
odm_get_version_mp_8197f_mac_reg(void)
{
		return 72;
}
