...
#ifndef _8822B_SDIO_H_
#define _8822B_SDIO_H_
...
#include "8822b_sdio_hw.h"
#include "8822b_sdio_recv.h"
#include "8822b_sdio_cmd.h"
...
struct hal_data_8822b
{
	...
	u16 SdioTxFIFOFreePage_prev[SDIO_TX_FREE_PG_QUEUE];
...
typedef struct hal_data_8822b HAL_INTF_DATA_TYPE, *PHAL_INTF_DATA_TYPE;
