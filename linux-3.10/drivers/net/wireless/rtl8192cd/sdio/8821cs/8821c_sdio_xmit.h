...
#ifndef _8821C_SDIO_XMIT_H_
#define _8821C_SDIO_XMIT_H_

#include "./8821c_sdio.h"
...
#define MAX_TX_AGG_PKT_NUM	(20)

#ifdef CONFIG_SDIO_TX_AGGREGATION
#define MAX_XMITBUF_PKT	20
#define MAX_XMITBUF_SZ		(1620*MAX_XMITBUF_PKT) // 15k 1536*10
