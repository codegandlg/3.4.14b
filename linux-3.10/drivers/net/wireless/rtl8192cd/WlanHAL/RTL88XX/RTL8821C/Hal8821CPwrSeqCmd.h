#ifndef REALTEK_POWER_SEQUENCE_8821C
#define REALTEK_POWER_SEQUENCE_8821C
...
/* 
	...
	TRANS_END
*/
#define	RTL8821C_TRANS_CARDEMU_TO_ACT_STEPS	16
#define	RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS	20
#define	RTL8821C_TRANS_CARDEMU_TO_SUS_STEPS	17
#define	RTL8821C_TRANS_SUS_TO_CARDEMU_STEPS	15
#define	RTL8821C_TRANS_CARDEMU_TO_PDN_STEPS	17
#define	RTL8821C_TRANS_PDN_TO_CARDEMU_STEPS	15
#define	RTL8821C_TRANS_ACT_TO_LPS_STEPS	20
#define	RTL8821C_TRANS_LPS_TO_ACT_STEPS	15	
#define	RTL8821C_TRANS_END_STEPS	1


#define RTL8821C_TRANS_CARDEMU_TO_ACT 														\
	/* format */																\
	...
	{ 0xFF1A, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_USB_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, 0xFF, 0 },                                                    /*0xFF1A = 0 to release resume signals*/ \
	{ 0x0006, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, BIT0, BIT0 },                                             /* release WLON reset  0x04[16]=1*/      \
	{ 0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, BIT7, 0 },                                                  /* disable HWPDN 0x04[15]=0*/ \
	{ 0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, (BIT4 | BIT3), 0 },                                       /* disable WL suspend*/      \
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT0, BIT0},/* polling until return 0*/	\
	{ 0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_POLLING, BIT0, 0 },                                                /**/        \
	{ 0x0020, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, BIT3, BIT3 },                                             /*Enable XTAL_CLK*/      \
	{ 0x0067, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK, PWR_BASEADDR_MAC, PWR_CMD_WRITE, BIT5, BIT5 },                                             /*0x67[5]=1 , BIT_PAPE_WLBT_SEL*/        \
	

#define RTL8821C_TRANS_ACT_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8821C_TRANS_CARDEMU_TO_SUS													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8821C_TRANS_SUS_TO_CARDEMU													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8821C_TRANS_CARDEMU_TO_CARDDIS													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
	...
	{0x001f, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x01f[1]=0 , disable RFC_0  control  REG_RF_CTRL_8821C */	\
	{0x0020, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x020[1]=0 , disable RFC_1  control  REG_RF_CTRL_8821C */	\
	{0x0021, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x021[1]=0 , disable RFC_2  control  REG_RF_CTRL_8821C */	\
	{0x0076, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT1, 0}, /* 0x076[1]=0 , disable RFC_3  control REG_OPT_CTRL_8821C +2 */	\
...
#define RTL8821C_TRANS_CARDDIS_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/                       \
...
#define RTL8821C_TRANS_CARDEMU_TO_PDN												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, BIT7},/* 0x04[15] = 1*/

#define RTL8821C_TRANS_PDN_TO_CARDEMU												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, 0},/* 0x04[15] = 0*/

#define RTL8821C_TRANS_ACT_TO_LPS														\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8821C_TRANS_LPS_TO_ACT															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
...
#define RTL8821C_TRANS_END																\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/		\
	{0xFFFF, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,0,PWR_CMD_END, 0, 0}, //


extern WLAN_PWR_CFG rtl8821C_power_on_flow[RTL8821C_TRANS_CARDEMU_TO_ACT_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_radio_off_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_card_disable_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_CARDEMU_TO_PDN_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_card_enable_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_CARDEMU_TO_PDN_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_suspend_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_CARDEMU_TO_SUS_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_resume_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_CARDEMU_TO_SUS_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_hwpdn_flow[RTL8821C_TRANS_ACT_TO_CARDEMU_STEPS+RTL8821C_TRANS_CARDEMU_TO_PDN_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_enter_lps_flow[RTL8821C_TRANS_ACT_TO_LPS_STEPS+RTL8821C_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8821C_leave_lps_flow[RTL8821C_TRANS_LPS_TO_ACT_STEPS+RTL8821C_TRANS_END_STEPS];
