	...
	)
{
	...
	if (bSelfBeamformer) { 
		PHYDM_DBG(ODMPTR, DBG_TXBF, "%s set TX IQ gen\n", __FUNCTION__);
		/*Paath_A*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_RCK_OS, 0xfffff, 0x08000);	/*Select Standby mode	0x30=0x08000*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_TXPA_G1, 0xfffff, 0x0005f);	/*Set Table data*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_TXPA_G2, 0xfffff, 0x01042);	/*Enable TXIQGEN in standby mode*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_RCK_OS, 0xfffff, 0x18000);	/*Select RX mode	0x30=0x18000*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_TXPA_G1, 0xfffff, 0x0004f);	/*Set Table data*/
		phy_set_rf_reg(priv, RF_PATH_A, RF_TXPA_G2, 0xfffff, 0x71fc2);	/*Enable TXIQGEN in RX mode*/
		/*Path_B*/
		phy_set_rf_reg(priv, RF_PATH_B, RF_RCK_OS, 0xfffff, 0x08000);
		phy_set_rf_reg(priv, RF_PATH_B, RF_TXPA_G1, 0xfffff, 0x00050);
		phy_set_rf_reg(priv, RF_PATH_B, RF_TXPA_G2, 0xfffff, 0x01042);
		phy_set_rf_reg(priv, RF_PATH_B, RF_RCK_OS, 0xfffff, 0x18000);
		phy_set_rf_reg(priv, RF_PATH_B, RF_TXPA_G1, 0xfffff, 0x00040);
		phy_set_rf_reg(priv, RF_PATH_B, RF_TXPA_G2, 0xfffff, 0x71fc2);
	}
