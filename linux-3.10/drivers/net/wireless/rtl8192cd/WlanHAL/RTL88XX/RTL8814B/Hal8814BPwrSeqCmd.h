#ifndef REALTEK_POWER_SEQUENCE_8814B
#define REALTEK_POWER_SEQUENCE_8814B
...
/* 
	...
	TRANS_END
*/
#define	RTL8814B_TRANS_CARDEMU_TO_ACT_STEPS	16
#define	RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS	20
#define	RTL8814B_TRANS_CARDEMU_TO_SUS_STEPS	17
#define	RTL8814B_TRANS_SUS_TO_CARDEMU_STEPS	15
#define	RTL8814B_TRANS_CARDEMU_TO_PDN_STEPS	17
#define	RTL8814B_TRANS_PDN_TO_CARDEMU_STEPS	15
#define	RTL8814B_TRANS_ACT_TO_LPS_STEPS	20
#define	RTL8814B_TRANS_LPS_TO_ACT_STEPS	15	
#define	RTL8814B_TRANS_END_STEPS	1


#define RTL8814B_TRANS_CARDEMU_TO_ACT 														\
	/* format */																\
...
#define RTL8814B_TRANS_ACT_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8814B_TRANS_CARDEMU_TO_SUS													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8814B_TRANS_SUS_TO_CARDEMU													\
	/* format */								\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8814B_TRANS_CARDEMU_TO_CARDDIS													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8814B_TRANS_CARDDIS_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/                       \
...
#define RTL8814B_TRANS_CARDEMU_TO_PDN												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, BIT7},/* 0x04[15] = 1*/

#define RTL8814B_TRANS_PDN_TO_CARDEMU												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, 0},/* 0x04[15] = 0*/

#define RTL8814B_TRANS_ACT_TO_LPS														\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8814B_TRANS_LPS_TO_ACT															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/	\
...
#define RTL8814B_TRANS_END																\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/		\
	{0xFFFF, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,0,PWR_CMD_END, 0, 0}, //


extern WLAN_PWR_CFG rtl8814B_power_on_flow[RTL8814B_TRANS_CARDEMU_TO_ACT_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_radio_off_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_card_disable_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_CARDEMU_TO_PDN_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_card_enable_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_CARDEMU_TO_PDN_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_suspend_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_CARDEMU_TO_SUS_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_resume_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_CARDEMU_TO_SUS_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_hwpdn_flow[RTL8814B_TRANS_ACT_TO_CARDEMU_STEPS+RTL8814B_TRANS_CARDEMU_TO_PDN_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_enter_lps_flow[RTL8814B_TRANS_ACT_TO_LPS_STEPS+RTL8814B_TRANS_END_STEPS];
extern WLAN_PWR_CFG rtl8814B_leave_lps_flow[RTL8814B_TRANS_LPS_TO_ACT_STEPS+RTL8814B_TRANS_END_STEPS];
