#ifndef __HAL8812F_FIRMWARE_H__
#define __HAL8812F_FIRMWARE_H__
...
Abstract:
	Defined HAL 8812F Firmware data structure & Define
...
#define ctrlInfoSZ_8812  32


typedef struct _Ctrl_Info_8812_ {
	u1Byte	SGI: 1;
	u1Byte Data_Rate: 7;
	u1Byte	PKT_DROP: 1;    
	u1Byte	TRY_RATE: 1;    
	...
	u1Byte	Rsvd4: 8;          
	u1Byte	Rsvd5: 8;          
} Ctrl_Info_8812, *PCtrl_Info_8812;
