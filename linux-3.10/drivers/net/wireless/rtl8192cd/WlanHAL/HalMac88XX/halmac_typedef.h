...
typedef enum halmac_cs_extra_action_id HALMAC_CS_EXTRA_ACTION_ID, _HALMAC_CS_EXTRA_ACTION_ID;
...
typedef struct halmac_drop_pkt_option HALMAC_DROP_PKT_OPTION, _HALMAC_DROP_PKT_OPTION, *PHALMAC_DROP_PKT_OPTION;
