...
struct halmac_intf_phy_para usb2_phy_param_8814b[] = {
...
struct halmac_intf_phy_para usb3_phy_param_8814b[] = {
	/* {offset, value, ip sel, cut mask, platform mask} */
	{0xFFFF, 0x0000,
	 HALMAC_IP_INTF_PHY,
	 HALMAC_INTF_PHY_CUT_ALL,
...
struct halmac_intf_phy_para pcie_gen1_phy_param_8814b[] = {
	/* {offset, value, ip sel, cut mask, platform mask} */
	{0xFFFF, 0x0000,
	 HALMAC_IP_INTF_PHY,
	 HALMAC_INTF_PHY_CUT_ALL,
...
struct halmac_intf_phy_para pcie_gen2_phy_param_8814b[] = {
	/* {offset, value, ip sel, cut mask, platform mask} */
	{0xFFFF, 0x0000,
	 HALMAC_IP_INTF_PHY,
	 HALMAC_INTF_PHY_CUT_ALL,
