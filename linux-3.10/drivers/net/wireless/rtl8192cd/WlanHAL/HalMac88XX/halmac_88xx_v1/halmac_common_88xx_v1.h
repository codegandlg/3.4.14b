...
#ifndef _HALMAC_COMMON_88XX_V1_H_
#define _HALMAC_COMMON_88XX_V1_H_
...
enum halmac_ret_status
send_scan_packet_88xx_v1(struct halmac_adapter *adapter, u8 index,
			 u8 *pkt, u32 size);
...
#endif/* _HALMAC_COMMON_88XX_V1_H_ */
