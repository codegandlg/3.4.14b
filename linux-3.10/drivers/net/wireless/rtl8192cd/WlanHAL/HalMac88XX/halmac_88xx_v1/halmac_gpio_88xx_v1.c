...
/**
 * pinmux_wl_led_mode_88xx_v1() -control wlan led gpio function
...
/**
 * pinmux_wl_led_sw_ctrl_88xx_v1() -control wlan led on/off
 * @adapter : the adapter of halmac
 * @on : on(1), off(0)
 * Author : Ivan Lin/Yong-Ching Lin
 * Return : enum halmac_ret_status
...
/**
 * pinmux_sdio_int_polarity_88xx_v1() -control sdio int polarity
 * @adapter : the adapter of halmac
...
/**
 * pinmux_gpio_mode_88xx_v1() -control gpio io mode
 * @adapter : the adapter of halmac
...
/**
 * pinmux_gpio_output_88xx_v1() -control gpio output high/low
 * @adapter : the adapter of halmac
 * @gpio_id : gpio0~15(0~15)
 * @high : high(1), low(0)
 * Author : Ivan Lin/Yong-Ching Lin
...
/**
 * halmac_pinmux_status_88xx_v1() -get current gpio status(high/low)
 * @adapter : the adapter of halmac
 * @pin_id : 0~15(0~15)
 * @phigh : high(1), low(0)
 * Author : Ivan Lin/Yong-Ching Lin
