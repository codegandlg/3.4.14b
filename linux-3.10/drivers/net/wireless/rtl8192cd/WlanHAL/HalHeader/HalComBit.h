...
#if (RTL8197F_SUPPORT || RTL8821C_SUPPORT || RTL8822B_SUPPORT)
...
#if (RTL8192E_SUPPORT || RTL8881A_SUPPORT || HALMAC_8822B_SUPPORT)
...
#if defined(BIT_PSTIMER_INT)
#undef BIT_SHIFT_PSTIMER_INT
#undef BIT_MASK_PSTIMER_INT
#undef BIT_PSTIMER_INT
#endif
...
/*redefined in line 18418, delete it*/
