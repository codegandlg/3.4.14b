 ...
 * DLAB=0
 */
#define _UART_RX		0	/* In:  Receive buffer */
#define _UART_TX		0	/* Out: Transmit buffer */
extern unsigned int serial_uart_rx, serial_uart_tx;
#define UART_RX		serial_uart_rx
#define UART_TX		serial_uart_tx
